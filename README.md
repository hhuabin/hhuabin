...
- 还有我学习 `react` 的以来基于`react 18.2.0` + `Vite` + `TS`搭建的**一站式框架 [reactinit](https://github.com/hhuabin/reactinit "reactinit")**（如字面意思只有个框架 :thumbsup: ），但我本人对此框架搭建极为满意，保证好用，后续还会陆续升级更新✨
  ...
  3. 框架里面有比较实用的hooks，供大家及我自己使用。其中有[性能监控hooks](https://github.com/hhuabin/reactinit/blob/main/src/hooks/utilsHooks/usePerformanceMonitor.ts "usePerformanceMonitor")、[项目自动更新hooks](https://github.com/hhuabin/reactinit/blob/main/src/hooks/domHooks/useProjectAutoUpdate.ts "useProjectAutoUpdate")、[大屏自适应hooks](https://github.com/hhuabin/reactinit/blob/main/src/hooks/domHooks/useScreenScale.ts "useScreenScale")，引入即可使用，自己研究的hooks，无需引用第三方插件，参考使用即可，欢迎大家提出意见
